...
This post is simply my previous web scraping scripts hockey applied to data for the 2019/2020 season, both the [Stavanger Oilers player statistics](https://www.kjartako.no/post/web-scraping-with-r-visualizing-hockey-statistics/) and [aggregated statistics for the Norwegian leauge](https://www.kjartako.no/post/hockey-web-scraping-data-aggregation/). 
